    ...
    <main className="min-h-screen bg-[#F5F0E8]">
      ...
      <div className="mx-auto max-w-3xl px-6 py-10 space-y-12">
        ...
        <section>
            ...
            <table className="w-full text-[13px]" style={{ borderCollapse: "collapse" }}>
              <thead>
                <tr>
                  ...
                  <th className="py-3 px-4 text-center text-white font-bold" style={{ background: "#2D5016", border: "0.5px solid #D3D1C7" }}>エアトランク</th>
              ...
              <tbody>
                {[
                  { label: "1箱・3ヶ月", self: 11154, ref: 2090 },
                  { label: "3箱・6ヶ月", self: 22308, ref: 7040 },
                  { label: "5箱・6ヶ月", self: 22308, ref: 11000 },
                  { label: "5箱・12ヶ月", self: 44616, ref: 20900 },
          ...
          <p className="text-[12px] text-[#888780] mt-2">※ エアトランクはスペースプランのため月額は箱数に比例しません。上記はベーシックプラン（3,718円/月）で算出。</p>
          <div className="mt-6">
