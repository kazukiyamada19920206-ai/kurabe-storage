            ...
            <table className="w-full text-[13px]" style={{ borderCollapse: "collapse" }}>
              <thead>
                <tr>
                  ...
                  <th className="py-3 px-4 text-center text-white font-bold" style={{ background: "#2D5016", border: "0.5px solid #D3D1C7" }}>宅トラ</th>
              ...
              <tbody>
                {[
                  { label: "1箱・3ヶ月", self: 2982, ref: 2090 },
                  { label: "3箱・6ヶ月", self: 10392, ref: 7040 },
                  { label: "5箱・6ヶ月", self: 16320, ref: 11000 },
                  { label: "5箱・12ヶ月", self: 31140, ref: 20900 },
